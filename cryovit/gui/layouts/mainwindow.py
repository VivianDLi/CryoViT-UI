...
"color: rgb(20, 20, 20);")
        ...
        self.sampleSelectFrame = QtWidgets.QFrame(parent=self.centralwidget)
        ...
        self.sampleSelectLayout.setContentsMargins(9, 9, 9, 9)
        ...
        self.gridLayout_6.addWidget(self.rawDirectoryLabel, 0, 0, 1, 2)
        self.rawDirectory = QtWidgets.QLineEdit(parent=self.processGroup)
        self.rawDirectory.setFrame(True)
        self.rawDirectory.setObjectName("rawDirectory")
        self.gridLayout_6.addWidget(self.rawDirectory, 0, 2, 1, 1)
        self.rawSelect = QtWidgets.QToolButton(parent=self.processGroup)
        self.rawSelect.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/open_folder.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.rawSelect.setIcon(icon1)
        self.rawSelect.setPopupMode(QtWidgets.QToolButton.ToolButtonPopupMode.DelayedPopup)
        self.rawSelect.setObjectName("rawSelect")
        self.gridLayout_6.addWidget(self.rawSelect, 0, 3, 1, 1)
        self.replaceCheckboxProc = QtWidgets.QCheckBox(parent=self.processGroup)
        self.replaceCheckboxProc.setChecked(True)
        self.replaceCheckboxProc.setObjectName("replaceCheckboxProc")
        self.gridLayout_6.addWidget(self.replaceCheckboxProc, 1, 0, 1, 1)
        self.replaceDirectoryLabelProc = QtWidgets.QLabel(parent=self.processGroup)
        ...
        self.gridLayout_6.addWidget(self.replaceDirectoryLabelProc, 1, 1, 1, 1)
        self.replaceDirectoryProc = QtWidgets.QLineEdit(parent=self.processGroup)
        self.replaceDirectoryProc.setEnabled(True)
        self.replaceDirectoryProc.setObjectName("replaceDirectoryProc")
        self.gridLayout_6.addWidget(self.replaceDirectoryProc, 1, 2, 1, 1)
        self.replaceSelectProc = QtWidgets.QToolButton(parent=self.processGroup)
        self.replaceSelectProc.setEnabled(True)
        self.replaceSelectProc.setText("")
        self.replaceSelectProc.setIcon(icon1)
        self.replaceSelectProc.setObjectName("replaceSelectProc")
        self.gridLayout_6.addWidget(self.replaceSelectProc, 1, 3, 1, 1)
        self.processButtonSeg = QtWidgets.QPushButton(parent=self.processGroup)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.processButtonSeg.setFont(font)
        self.processButtonSeg.setObjectName("processButtonSeg")
        self.gridLayout_6.addWidget(self.processButtonSeg, 2, 0, 1, 4)
        self.verticalLayout.addWidget(self.processGroup)
        ...
        self.gridLayout_2.addWidget(self.modelCombo, 2, 1, 1, 7)
        ...
        self.gridLayout_2.addWidget(self.modelInfoBox, 3, 4, 1, 7)
        self.addModelButton = QtWidgets.QToolButton(parent=self.segGroup)
        self.addModelButton.setText("")
        self.addModelButton.setIcon(icon)
        self.addModelButton.setObjectName("addModelButton")
        self.gridLayout_2.addWidget(self.addModelButton, 2, 9, 1, 1)
        ...
        self.selectedModelScroll.setGeometry(QtCore.QRect(0, 0, 237, 250))
        ...
        self.gridLayout_2.addWidget(self.selectedModelArea, 3, 0, 1, 4)
        self.featureButtonSeg = QtWidgets.QPushButton(parent=self.segGroup)
        self.featureButtonSeg.setObjectName("featureButtonSeg")
        self.gridLayout_2.addWidget(self.featureButtonSeg, 5, 0, 1, 11)
        ...
        self.gridLayout_2.addWidget(self.importModelButton, 2, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.segmentButton, 7, 0, 1, 11)
        ...
        self.gridLayout_2.addWidget(self.removeModelButton, 2, 10, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.modelLabel, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.replaceCheckboxSeg, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.replaceDirectoryLabelSeg, 1, 1, 1, 1)
        ...
        self.replaceSelectSeg.setIcon(icon1)
        self.replaceSelectSeg.setObjectName("replaceSelectSeg")
        self.gridLayout_2.addWidget(self.replaceSelectSeg, 1, 10, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.replaceDirectorySeg, 1, 2, 1, 8)
        ...
        self.sliceSelect.setIcon(icon1)
        ...
        self.dataSelectTrain.setIcon(icon1)
...
"border-color: rgb(90, 90, 90);")
        ...
        self.actionGenerate_New_Training_Splits = QtGui.QAction(parent=MainWindow)
        self.actionGenerate_New_Training_Splits.setObjectName("actionGenerate_New_Training_Splits")
        ...
        self.menuTools.addAction(self.actionGenerate_New_Training_Splits)
        self.menuRun.addAction(self.use_local_training)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.processGroup.setTitle(_translate("MainWindow", "Pre-processing"))
        ...
        self.dataDirectory.setPlaceholderText(_translate("MainWindow", "/path/to/directory/with/data/features"))
        ...
        self.actionGenerate_New_Training_Splits.setText(_translate("MainWindow", "Generate New Training Splits"))
