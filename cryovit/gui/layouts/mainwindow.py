...
"color: rgb(20, 20, 20);")
        ...
        self.gridLayout_2.addWidget(self.segmentButton, 4, 0, 1, 11)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/remove.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.removeModelButton.setIcon(icon1)
        ...
        self.selectedModelScroll.setGeometry(QtCore.QRect(0, 0, 239, 298))
