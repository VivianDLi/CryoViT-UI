...
"color: rgb(20, 20, 20);")
        ...
        self.gridLayout_2.addWidget(self.addModelButton, 0, 7, 1, 1)
        ...
        self.importModelButton.setIcon(icon2)
        self.importModelButton.setObjectName("importModelButton")
        self.gridLayout_2.addWidget(self.importModelButton, 0, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.replaceSelectSeg, 2, 8, 1, 1)
        ...
        self.modelStack = QtWidgets.QStackedWidget(parent=self.modelInfoBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.modelStack.sizePolicy().hasHeightForWidth())
        self.modelStack.setSizePolicy(sizePolicy)
        self.modelStack.setObjectName("modelStack")
        self.modelTemplate = QtWidgets.QWidget()
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.modelTemplate.sizePolicy().hasHeightForWidth())
        self.modelTemplate.setSizePolicy(sizePolicy)
        self.modelTemplate.setObjectName("modelTemplate")
        self.formLayout_2 = QtWidgets.QFormLayout(self.modelTemplate)
        ...
        self.modelScroll = QtWidgets.QScrollArea(parent=self.modelTemplate)
        self.modelScroll.setWidgetResizable(True)
        self.modelScroll.setObjectName("modelScroll")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 528, 273))
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.nameLabel)
        self.nameDisplay = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.nameDisplay.setObjectName("nameDisplay")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.nameDisplay)
        self.archLabel = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.archLabel.setObjectName("archLabel")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.archLabel)
        self.segmentLabel = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.segmentLabel.setObjectName("segmentLabel")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.segmentLabel)
        self.segmentDisplay = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.segmentDisplay.setObjectName("segmentDisplay")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.segmentDisplay)
        self.metricLabel = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.metricLabel.setObjectName("metricLabel")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.metricLabel)
        self.metricDisplay = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.metricDisplay.setObjectName("metricDisplay")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.metricDisplay)
        self.archDisplay = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.archDisplay.setObjectName("archDisplay")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.archDisplay)
        self.sampleLabel = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.sampleLabel.setObjectName("sampleLabel")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.sampleLabel)
        self.sampleDisplay = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.sampleDisplay.setObjectName("sampleDisplay")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.sampleDisplay)
        self.modelScroll.setWidget(self.scrollAreaWidgetContents)
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.modelScroll)
        self.modelStack.addWidget(self.modelTemplate)
        self.horizontalLayout.addWidget(self.modelStack)
        self.gridLayout_2.addWidget(self.modelInfoBox, 1, 0, 1, 9)
        ...
        self.gridLayout_2.addWidget(self.modelCombo, 0, 1, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.replaceDirectoryLabelSeg, 2, 1, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/remove.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.removeModelButton.setIcon(icon3)
        self.removeModelButton.setObjectName("removeModelButton")
        self.gridLayout_2.addWidget(self.removeModelButton, 0, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.replaceDirectorySeg, 2, 2, 1, 6)
        ...
        self.gridLayout_2.addWidget(self.replaceCheckboxSeg, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.segmentButton, 3, 0, 1, 9)
        ...
        self.formLayout = QtWidgets.QFormLayout(self.sampleSelectFrame)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.sampleSelectLabel)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.sampleSelectCombo)
        ...
        self.gridLayout_4.addWidget(self.sliceDirectoryLabel, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.sliceSelect, 1, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.splitsButton, 5, 0, 1, 3)
        self.features = QtWidgets.QLineEdit(parent=self.annotGroup)
        self.features.setObjectName("features")
        self.gridLayout_4.addWidget(self.features, 4, 1, 1, 1)
        self.annoDirectoryLabel = QtWidgets.QLabel(parent=self.annotGroup)
        self.annoDirectoryLabel.setObjectName("annoDirectoryLabel")
        self.gridLayout_4.addWidget(self.annoDirectoryLabel, 3, 0, 1, 1)
        self.featuresLabel = QtWidgets.QLabel(parent=self.annotGroup)
        self.featuresLabel.setObjectName("featuresLabel")
        self.gridLayout_4.addWidget(self.featuresLabel, 4, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.annoSelect, 3, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.featuresAdd, 4, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.splitsButtonNew, 6, 0, 1, 3)
        ...
        self.gridLayout_5.addWidget(self.trainButton, 2, 0, 1, 3)
...
"border-color: rgb(90, 90, 90);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.replaceDirectoryProc.setPlaceholderText(_translate("MainWindow", "/path/to/processed/directory"))
        ...
        self.rawDirectory.setPlaceholderText(_translate("MainWindow", "/path/to/raw/directory"))
        ...
        self.nameLabel.setText(_translate("MainWindow", "Model Name:"))
        self.nameDisplay.setText(_translate("MainWindow", "TextLabel"))
        self.archLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>The architecture of the model (determines general model capabilities).</p></body></html>"))
        self.archLabel.setText(_translate("MainWindow", "Model Architecture:"))
        self.segmentLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>What label (e.g., mitochondria, christae) the model is trained to segment.</p></body></html>"))
        self.segmentLabel.setText(_translate("MainWindow", "Segmentation Label:"))
        self.segmentDisplay.setText(_translate("MainWindow", "TextLabel"))
        self.metricLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>General training performance of the model.</p><p><br/></p><p>For DICE score, the closer to 1, the better (i.e., the more closely the model\'s segmentation matched the ground truth in training).</p></body></html>"))
        self.metricLabel.setText(_translate("MainWindow", "Training Metrics:"))
        self.metricDisplay.setText(_translate("MainWindow", "TextLabel"))
        self.archDisplay.setText(_translate("MainWindow", "TextLabel"))
        self.sampleLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>The dataset the model was trained on.</p></body></html>"))
        self.sampleLabel.setText(_translate("MainWindow", "Dataset Samples:"))
        self.sampleDisplay.setText(_translate("MainWindow", "TextLabel"))
        ...
        self.sampleSelectCombo.setToolTip(_translate("MainWindow", "<html><head/><body><p>Samples to use for training. If none are selected, tomograms in the <span style=\" font-weight:700;\">Raw Tomogram Directory </span>will be used, and the directory folder name will be taken as the sample name.</p><p>New samples can be added to the list.</p></body></html>"))
        ...
        self.replaceDirectoryProcTrain.setPlaceholderText(_translate("MainWindow", "/path/to/processed/directory"))
        ...
        self.sliceDirectory.setToolTip(_translate("MainWindow", "<html><head/><body><p>The directory to save tomogram slices to manually segment for ground truth labels as <span style=\" font-weight:700;\">.pngs</span>.</p></body></html>"))
        self.sliceDirectory.setPlaceholderText(_translate("MainWindow", "/path/to/directory/with/png/slices"))
        self.csvDirectory.setToolTip(_translate("MainWindow", "<html><head/><body><p>The directory where all .csv files, including <span style=\" font-weight:700;\">sample.csv</span> and <span style=\" font-weight:700;\">splits.csv</span> are located.</p></body></html>"))
        ...
        self.features.setToolTip(_translate("MainWindow", "<html><head/><body><p>A comma-separated list of segmentation labels, in order of decreasing pixel value in the annotation .png.</p><p>The list can either be edited manually, or new features can be added with the + button on the right.</p></body></html>"))
        self.features.setPlaceholderText(_translate("MainWindow", "list features labeled in order of decreasing value"))
